...
interface FragranceDocumentData {
  ...
  /**
   * BottleImage field in *Fragrance*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fragrance.bottleimage
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  bottleimage: prismic.ImageField<never>;

  /**
   * FeatureImage field in *Fragrance*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fragrance.featureimage
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  featureimage: prismic.ImageField<never>;
   ...
   */
  scent_profile: prismic.SelectField<"spicy" | "woody" | "freah", "filled">;
