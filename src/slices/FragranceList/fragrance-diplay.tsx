...
import { FragranceAttributes } from "@/components/fragrance-attributes";
...
export const FragranceDisplay = async ({ id }: FragranceDisplayProps) => {
  ...
  return (
    <FadeIn
      className="relative z-10 grid min-h-[85vh] w-full translate-y-20 items-center justify-items-start border border-white/10 text-left md:p-14 lg:p-20"
      vars={{ duration: 2.5 }}
      start="top 50%"
    >
      <div className="absolute inset-0 z-0">
        <PrismicNextImage
          field={fragrance.data.featureimage}
